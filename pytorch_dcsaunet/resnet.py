...
class ResNet(nn.Module): 
    #dilated: 是否使用空洞卷积（dilated convolution）。 dilation: 空洞卷积的扩张率。
    #rectified_conv: 是否使用修正线性单元（ReLU）。
    #rectify_avg: 是否在计算平均值前使用ReLU。
    #last_gamma: 是否在最后一层使用缩放因子gamma
    #stem_width: 输入处理模块的输出通道数。
